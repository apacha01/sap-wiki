...
export default function CardFood({ model }: { model: Toy }) {
	...
	return (
		...
		>
			...
			<div class="w-full flex justify-center items-end gap-4">
				...
				<span class="bg-clock bg-contain bg-no-repeat aspect-square w-12 leading-[3rem] text-black text-center text-xl">2</span>
			</div>
		</article>
	);
}
