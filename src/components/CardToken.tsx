...
export default function CardToken({ model }: { model: Token }) {
	...
	const hpIndex = model.stats.lv1_stats[0].name.localeCompare('hp') === 0 ? 0 : 1;
	const hp = model.stats.lv1_stats[hpIndex].base_stat;
	const atk = model.stats.lv1_stats[hpIndex === 0 ? 1 : 0].base_stat;
